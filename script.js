...
document.getElementById("generate-btn").addEventListener("click", function () {
  ...
  if (mainText.scrollHeight > mainText.clientHeight) {
    alert(
      "Warning: Some text may be cut off in the generated image due to overflow."
    );
  }
...
document
  ...
  .addEventListener("click", function () {
    ...
    const pdfName = prompt(
      "Enter the name for the PDF file:",
      "generated-images"
    );
    if (!pdfName) {
...
document
  .querySelector(".coffee-image img")
  .addEventListener("click", function () {
...
editableElement.addEventListener("paste", function (event) {
  ...
  // Insert the plain text into the contenteditable field
